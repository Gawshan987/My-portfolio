...
export default function Navbar() {
  return (
    <div className="w-full h-full bg-[url(https://images.unsplash.com/photo-1513569771920-c9e1d31714af?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80)] bg-no-repeat bg-cover min-h-screen">
      ...
      <div className="grid grid-cols-2">
        <div className="flex flex-col justify-center items-center pl-2 bg-[#00000040]">
          <h1 className="text-black font-semibold text-xl font-sans">
            My Story
          </h1>
